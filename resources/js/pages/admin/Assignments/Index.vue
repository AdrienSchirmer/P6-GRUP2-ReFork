    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="relative flex h-full flex-1 flex-col gap-6 overflow-x-auto p-4 md:p-6">
            ...
            <div class="relative max-w-md">
                <input type="text" v-model="search" placeholder="Cercar encàrrecs..."
                ...
                <svg class="pointer-events-none absolute top-1/2 right-4 h-4 w-4 -translate-y-1/2 text-muted-foreground"
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                <div v-for="ass in filteredAssignments" :key="ass.id"
                    ...
                    <!-- Top -->
                    <div class="flex items-start justify-between border-b border-sidebar-border/70 p-5">
                        <div>
                    ...
                    <!-- Actions -->
                    <div class="flex items-center gap-2 border-t border-sidebar-border/70 p-4">
                        <!-- Pending -->
                        <div class="group/action relative flex-1">
                            <Link :href="`/admin/adminAssignments/${ass.id}`" :data="{ status: 'pending' }"
                                preserve-scroll method="patch"
                        ...
                        <!-- Cancel -->
                        <div class="group/action relative flex-1">
                            <Link :href="`/admin/adminAssignments/${ass.id}`" :data="{ status: 'cancelled' }"
                                preserve-scroll method="patch"
                        ...
                        <!-- Complete -->
                        <div class="group/action relative flex-1">
                            <Link :href="`/admin/adminAssignments/${ass.id}`" :data="{ status: 'completed' }"
                                preserve-scroll method="patch"
