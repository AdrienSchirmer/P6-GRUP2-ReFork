            ...
            <div class="rounded-xl border bg-white p-6 shadow">
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input v-model="form.name" type="text" placeholder="Ex.: Consulta general"
                                aria-label="Nom del servei" class="mt-1 w-full rounded-lg border px-3 py-2 text-sm" />
                        ...
                        <div>
                            ...
                            <input v-model="form.duration_minutes" type="number" min="1" aria-label="Durada (minuts)"
                                class="mt-1 w-full rounded-lg border px-3 py-2 text-sm" />
                            <p v-if="form.errors.duration_minutes" class="mt-1 text-xs text-red-500">
                    ...
                    <div>
                        ...
                        <TiptapEditor id="service-description" v-model="form.description"
                            placeholder="Descripció breu del servei…" class="mt-1" />
                    ...
                    <div>
                        ...
                        <p v-if="form.errors.icon" class="mt-1 text-xs text-red-500">
                            {{ form.errors.icon }}
                        </p>
                    </div>
