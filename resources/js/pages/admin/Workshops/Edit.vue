    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="relative flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4 md:p-6">
            ...
            <div class="relative rounded-2xl border border-sidebar-border/70 bg-background/95 p-6 shadow-sm">
                <Form :action="workshopsUpdate(workshop.id).url" method="put"
                    #default="{ errors, processing, progress }" class="grid gap-5">
                    <div class="grid gap-2">
                        <Label for="name">Nom</Label>
                        <Input id="name" type="text" name="name" :default-value="workshop.name" required autofocus
                    ...
                    <div class="grid gap-2">
                        ...
                        <div v-if="photoPreview" class="overflow-hidden rounded-xl bg-muted/20">
                            <img :src="photoPreview" alt="Foto actual del taller" class="h-40 w-60 object-cover" />
                        </div>
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <div class="grid gap-2">
                            ...
                            <Input id="workshop_date" type="date" name="workshop_date" :default-value="formattedDate"
                                required />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="max_attendees" type="number" name="max_attendees"
                                :default-value="workshop.max_attendees ?? ''" min="1" placeholder="Ex.: 20" />
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <div class="grid gap-2">
                            ...
                            <Input id="start_time" type="time" name="start_time" :default-value="formattedStartTime"
                                required />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="end_time" type="time" name="end_time" :default-value="formattedEndTime"
                                required />
                    ...
                    <div class="grid gap-2">
                        ...
                        <select id="is_active" name="is_active" v-model="isActive"
