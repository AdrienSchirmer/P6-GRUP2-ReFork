...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            ...
            <!-- Main panel -->
            <div
                class="relative rounded-2xl border border-sidebar-border/70 bg-background/95 p-5 shadow-sm md:p-6"
            >
                <!-- Toolbar -->
                <div
                ...
                <!-- Table -->
                <div
                    class="overflow-x-auto rounded-xl border border-sidebar-border/60"
                >
                    <table
                        class="min-w-full divide-y divide-sidebar-border/70 text-sm"
                    >
                        <thead
                            class="bg-muted/50 backdrop-blur supports-[backdrop-filter]:bg-muted/100"
                        >
                            <tr>
                                <th
