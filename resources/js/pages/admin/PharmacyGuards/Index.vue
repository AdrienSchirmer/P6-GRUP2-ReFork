...
const visibleGuards = computed(() => {
    ...
    return pharmacyguardsData.value.slice(start, end);
});

const totalPages = computed(() =>
    Math.ceil(pharmacyguardsData.value.length / perPage),
);
                    ...
                    <div class="grid gap-3 md:grid-cols-4">
                        ...
                        <div class="relative md:col-span-1">
                            ...
                            <input
                                ...
                                @keyup="filterGuards()"
                                type="search"
                                placeholder="Nom farmàcia..."
                                class="mt-1.5 w-full rounded-xl border border-sidebar-border/80 bg-background px-4 py-2 text-sm shadow-xs transition focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:outline-none"
                            />
                        </div>
