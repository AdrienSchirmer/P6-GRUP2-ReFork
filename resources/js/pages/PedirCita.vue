    ...
    <div class="bg-[#f3f4f6] text-slate-900">
        <section class="py-10">
            <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
                <div>
                    <span class="inline-block px-3 py-1 text-[10px] font-semibold tracking-widest uppercase bg-[#e5e7eb] text-[#8a6d1a] rounded-full mb-3">
                ...
                <div>
                    ...
                    <div v-if="step === 1">
                        <div class="flex items-center gap-3 mb-8">
                            <span class="w-8 h-8 rounded-full bg-[#0f5f7f] text-white flex items-center justify-center font-bold text-sm">1</span>
                    ...
                    <div v-if="step === 2">
                        <div class="flex items-center gap-3 mb-8">
                            <span class="w-8 h-8 rounded-full bg-[#0f5f7f] text-white flex items-center justify-center font-bold text-sm">2</span>
                        ...
                        <div class="grid md:grid-cols-2 gap-6 items-start">
                            <div class="bg-[#f3f4f6] rounded-xl p-4">
                                <div class="flex items-center justify-between mb-3">
                                    <button @click="prevMonth" class="p-1.5 rounded-lg text-slate-500 hover:bg-white hover:text-[#0f5f7f] transition">
                                        <ChevronLeft class="w-5 h-5" />
                                    </button>
                                    <span class="font-semibold text-slate-700 text-sm">{{ currentMonthLabel }}</span>
                                    <button @click="nextMonth" class="p-1.5 rounded-lg text-slate-500 hover:bg-white hover:text-[#0f5f7f] transition">
                                        <ChevronRight class="w-5 h-5" />
                                    </button>
                                </div>

                                <div class="grid grid-cols-7 mb-2">
                                    <div v-for="h in dayHeaders" :key="h" class="text-center text-xs font-semibold text-slate-400 py-1">
                                        {{ h }}
                                    </div>
                                </div>
                    ...
                    <div v-if="step === 3">
                        <div class="flex items-center gap-3 mb-8">
                            <span class="w-8 h-8 rounded-full bg-[#0f5f7f] text-white flex items-center justify-center font-bold text-sm">3</span>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 mb-1">Correu Electrònic</label>
                                    <input
                                    ...
                                    <div class="space-y-2 text-sm text-slate-600">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium">
                                                {{ selectedDate ? `${selectedDate} ${monthNames[currentMonth]} ${currentYear}` : '—' }}
                                            </span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span>Hora</span>
                ...
                <div class="relative p-4 w-full max-w-md">
                    <div class="bg-white rounded-lg shadow-xl p-6">
                        ...
                        <div class="flex justify-between items-center border-b pb-4">
                            ...
                            <button @click="showModal = false" class="text-gray-400 hover:text-black transition">✕</button>
                        </div>
                        ...
                        <div class="bg-gray-100 rounded-lg p-3 space-y-2 text-xs mb-4">
                            ...
                            <div class="border-t border-gray-300 pt-2 mt-1 space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold text-gray-800 truncate max-w-[200px]">{{ successData?.email }}</span>
                                </div>
                            </div>
                        </div>

                        <!-- Captcha -->
                        <div class="mb-4 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 flex items-center justify-center h-[78px]">
