                ...
                <div class="flex flex-1 flex-col gap-6">
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <p>
                                Aquest taller ja està complet. Si vols, pots
                                contactar amb nosaltres per a properes edicions.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                <label
                                    for="name"
                                    class="mb-1 block text-xs font-medium text-[#0E3C4D]"
                                >
                                    Nom complet
                                ...
                                <input
                                    ...
                                    autocomplete="name"
                                    required
                                    class="w-full rounded-lg border border-[#D0EAF3] bg-white px-3 py-2 text-sm text-[#0E3C4D] transition outline-none focus:border-[#01617F] focus:ring-2 focus:ring-[#01617F]/20"
                                    :class="{
