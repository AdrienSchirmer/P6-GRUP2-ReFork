...
<template>
    <WebAppLayout>
        <div class="relative min-h-screen overflow-hidden bg-slate-50">
            ...
            <div class="pointer-events-none absolute inset-x-0 top-0 -z-0 h-[420px] opacity-[0.06]" style="
                    background-image: radial-gradient(circle at 1px 1px, white 1px, transparent 0);
                    background-size: 24px 24px;
                "></div>

            <div class="relative z-10 mx-auto max-w-7xl px-4 pt-10 pb-16 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        ...
                        <div class="overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-slate-900/5">
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-4">
                                    <span
                                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#00617E] to-[#004e66] text-sm font-bold text-white shadow-md shadow-[#00617E]/20 ring-4 ring-[#00617E]/10">
                                        1
                                    </span>
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-sm text-slate-500">
                                            ...
                                            Tots els camps marcats amb * són
                                            obligatoris.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <Form ref="formRef" :action="store()" method="POST" class="space-y-6 p-6 sm:p-8"
                                @success="onSuccess" #default="{ errors, validating }">
                                <!-- Name -->
                                <div>
                                    ...
                                    <div class="relative">
                                        <span
                                            ...
                                            :class="{ 'text-[#00617E]': focusedField === 'name' }">
                                        ...
                                        <input id="name" type="text" name="name" autocomplete="name"
                                            ...
                                            :class="{ 'border-rose-400 ring-4 ring-rose-100': errors.name }"
                                            @focus="focusedField = 'name'" @blur="focusedField = null" />
                                    </div>
                                    <p v-if="errors.name" class="mt-1.5 flex items-center gap-1 text-xs text-rose-600">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div>
                                        ...
                                        <div class="relative">
                                            <span
                                                class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400"
                                                :class="{ 'text-[#00617E]': focusedField === 'address' }">
                                            ...
                                            <input id="address" type="text" name="address" autocomplete="email-address"
                                                placeholder="Nom@domini.com"
                                                class="block w-full rounded-lg border border-slate-300 bg-white py-2.5 pr-4 pl-10 text-sm text-slate-900 placeholder-slate-400 shadow-sm transition focus:border-[#00617E] focus:ring-4 focus:ring-[#00617E]/10 focus:outline-none"
                                                :class="{ 'border-rose-400 ring-4 ring-rose-100': errors.address }"
                                                @focus="focusedField = 'address'" @blur="focusedField = null" />
                                        </div>
                                        <p v-if="errors.address" class="mt-1.5 text-xs text-rose-600">
                                            {{ errors.address }}
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            <span
                                                class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400"
                                                :class="{ 'text-[#00617E]': focusedField === 'phone_number' }">
                                                <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                                    <path
                                            ...
                                            <input id="phone_number" type="tel" name="phone_number" autocomplete="tel"
                                                inputmode="numeric" placeholder="600 12 31 23"
                                                class="block w-full rounded-lg border border-slate-300 bg-white py-2.5 pr-4 pl-10 text-sm text-slate-900 placeholder-slate-400 shadow-sm transition focus:border-[#00617E] focus:ring-4 focus:ring-[#00617E]/10 focus:outline-none"
                                                :class="{ 'border-rose-400 ring-4 ring-rose-100': errors.phone_number }"
                                                @focus="focusedField = 'phone_number'" @blur="focusedField = null" />
                                        </div>
                                        <p v-if="errors.phone_number" class="mt-1.5 text-xs text-rose-600">
                                            {{ errors.phone_number }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="mb-2 flex items-center justify-between">
                                        ...
                                        <span class="text-xs font-medium tabular-nums" :class="descriptionLength > 450
                                                ? 'text-amber-600'
                                                : 'text-slate-400'
                                            ">
                                    ...
                                    <textarea id="description" name="description" rows="6" maxlength="500"
                                        ...
                                        :class="{ 'border-rose-400 ring-4 ring-rose-100': errors.description }"
                                        @input="onDescriptionInput" />
                                    <p v-if="errors.description" class="mt-1.5 text-xs text-rose-600">
                                        {{ errors.description }}
                                    </p>
                                </div>
                                ...
                                <div
                                    ...
                                    <label for="terms" class="text-sm leading-relaxed text-slate-700">
                                        He llegit i accepto les
                                        <a href="#"
                                            class="font-semibold text-[#00617E] underline-offset-2 hover:underline">condicions
                                            d'ús</a>
                                        i la
                                        <a href="#"
                                            class="font-semibold text-[#00617E] underline-offset-2 hover:underline">política
                                            de privacitat</a>.
                                    </label>
                                </div>
                                ...
                                <div v-if="props.turnstileSiteKey">
                                    <div class="cf-turnstile" :data-sitekey="props.turnstileSiteKey" data-language="es">
                                    </div>
                                    <p v-if="errors['cf-turnstile-response']" class="mt-1.5 text-xs text-rose-600">
                                ...
                                <div
                                    ...
                                    <p class="flex items-center gap-2 text-xs text-slate-500">
                                        <svg class="h-3.5 w-3.5 text-emerald-500" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                    ...
                                    <button type="submit" :disabled="validating"
                                        ...
                                        <svg v-if="validating" class="h-4 w-4 animate-spin" viewBox="0 0 24 24"
                                            fill="none">
                                        ...
                                        {{ validating ? 'Enviant…' : 'Enviar encàrrec' }}
                                        <svg v-if="!validating" class="h-4 w-4 transition group-hover:translate-x-0.5"
                    ...
                    <aside class="space-y-5">
                        <!-- How it works -->
                        <div class="overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-slate-900/5">
                            <div class="relative h-36 overflow-hidden bg-gradient-to-br from-[#00617E] to-[#004e66]">
                                <img src="/storage/vagaro-ckWrZO5sWOQ-unsplash.jpg" alt="Farmàcia Soler"
                                ...
                                <div class="absolute right-5 bottom-4 left-5">
                                    <p class="text-xs font-semibold tracking-wider text-white/80 uppercase">
                                        Següent pas
                                    </p>
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <p class="mt-1 text-sm leading-relaxed text-slate-600">
                                            T'avisarem amb un missatge tan
                                            aviat com estigui llest per
                                            recollir.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <p class="mt-3 text-sm text-white/80">
                                Truca'ns directament o vine a la farmàcia.
                                Estem oberts de dilluns a dissabte.
                            </p>
                            <a href="tel:+34972500299"
        ...
        <transition enter-active-class="transition duration-200 ease-out" enter-from-class="opacity-0"
            ...
            <div v-if="showModal"
                ...
                <transition enter-active-class="transition duration-300 ease-out" enter-from-class="scale-95 opacity-0"
                    ...
                    <div v-if="showModal"
                        ...
                        <!-- Header -->
                        <div class="flex items-start justify-between px-6 pt-6 sm:px-8">
                            <div class="flex items-center gap-4">
                                <span
                                    class="relative flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100">
                                    <span
                                        class="absolute inset-0 animate-ping rounded-full bg-emerald-300 opacity-30"></span>
                                    <svg class="relative h-6 w-6 text-emerald-600" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="px-6 py-5 sm:px-8">
                            ...
                            <dl class="mt-4 divide-y divide-slate-100 rounded-xl bg-slate-50 ring-1 ring-slate-200/60">
                                <div class="grid grid-cols-3 gap-4 px-4 py-3">
                                    <dt class="text-xs font-semibold tracking-wide text-slate-500 uppercase">
                                        Nom
                                    </dt>
                                    <dd class="col-span-2 text-sm font-medium text-slate-900">
                                        {{ props.name }}
                                    </dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 px-4 py-3">
                                ...
                                <div class="grid grid-cols-3 gap-4 px-4 py-3">
                                    ...
                                    <dd
                                        class="col-span-2 text-sm whitespace-pre-line text-slate-900 [overflow-wrap:anywhere]">
                                        {{ props.description }}
                                    </dd>
                                </div>
                            </dl>
                            <div
                                ...
                                <svg class="mt-0.5 h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path
